...
```console
docker build -f .\AspNetFramworkVBWebForm\Dockerfile --force-rm -t aspnetframworkvbwebform:dev .
```

# DOCKER RUN COMMAND 

```console
docker run --name aspnetframworkvbwebform --rm -it -p 8000:80 aspnetframworkvbwebform:dev
```
